...
static char *auth_bearer_request(struct ret_data *data,
...
static int *verify_user(jwt_t * jwt, const char *user, const char *domain)
{
				   ...
				   int argc, const char **argv)
{
	...
	*domain, *u_code, *d_code, *ab_token;
	...
	tenant = json_string_value(json_object_get(config, "tenant"));
    } else {
